  ...
  return (
    <div className="min-h-screen w-full relative flex items-center justify-center py-12 bg-slate-50 font-sans overflow-hidden antialiased text-slate-600">
      ...
      <div className="absolute inset-0 z-0 opacity-40 mix-blend-multiply pointer-events-none">
        <div className="absolute top-[-20%] left-[-10%] w-[600px] h-[600px] bg-purple-200 rounded-full blur-[120px]" />
        <div className="absolute bottom-[-20%] right-[-10%] w-[500px] h-[500px] bg-blue-100 rounded-full blur-[100px]" />
      </div>
        ...
        <div className="bg-white border border-slate-100 p-8 md:p-10 shadow-xl rounded-[2.5rem] transition-all">
          ...
          {isSuccess ? (
            <div className="py-10 flex flex-col items-center justify-center text-center animate-in fade-in zoom-in duration-500">
              ...
              <h2 className="text-xl font-black text-slate-900 uppercase tracking-wider">Deployment Ready</h2>
              <p className="text-[9px] text-slate-400 font-bold uppercase tracking-widest mt-1.5">Operator Registered Successfully</p>
            ...
            <>
              ...
              <form className="space-y-5" onSubmit={handleSignup}>
                ...
                <div className="space-y-1.5">
                  <label className="text-[9px] font-bold uppercase tracking-wider text-slate-400 ml-0.5">Full Name</label>
                  <div className="relative group">
                    <User className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within:text-purple-600 transition-colors" size={16} />
                    <input 
                      required 
                      type="text" 
                      value={name} 
