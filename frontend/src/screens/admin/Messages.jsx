...
const Messages = () => {
  ...
  const fetchMessages = async () => {
    ...
    try {
      ...
      setMessages([
        { _id: '1', name: 'abeba', email: 'abel@gmail.com', message: 'dchbffrg', status: 'NEW', date: '4/25/2026' },
        { _id: '2', name: 'sdffgg', email: 'abel@gmail.com', message: 'dcffgghhjj', status: 'READ', date: '4/25/2026' },
        { _id: '3', name: 'hawi', email: 'hawi@gmail.com', message: 'good', status: 'NEW', date: '4/25/2026' },
      ]);
    } finally {
      setLoading(false);
    }
